    ...
    return (
        <>
            <div className='bg-purple-800 min-h-screen'>
                <Link to="/register"><div className='bg-teal-500 flex justify-center py-1 text-white hover:bg-orange-400 hover:duration-300 cursor-pointer shadow-lg'>Get Started Now!</div></Link>
                <div className="bg-green-500 min-h-[500px] bg-[url('https://i.ibb.co/RNC9zYL/banner.jpg')] bg-center bg-cover flex justify-center items-center ">
                    <Link to="/blog"><button className='bg-teal-500 p-3 text-2xl text-white rounded-lg hover:bg-teal-900 hover:duration-300 mt-[200px]'>View our fitness blog</button></Link>
