            ...
            return (
                <>
                    <div className='min-h-screen bg-purple-800'>
                        ...
                        <Stats sessions={sessions} usernum={totalUsers} />
                        ...
                        {sessions.map(session => {
                            return <div key={session.session_id} className='bg-purple-300 p-2 m-3 rounded-lg flex justify-between'>
                                <h1 className='text-center text-2xl'>ID: {session.session_id}</h1>
                                <h1 className='text-center text-2xl'>Date: {session.fdate}</h1>
                                <h1 className='text-center text-2xl'>Time: {session.time}</h1>
                                <h1 className='text-center text-2xl'>Name: {session.name}</h1>
                                <h1 className='text-center text-2xl'>Space: {session.max_space}</h1>
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div className="mt-2">
                                    <form className='flex flex-col justify-center items-center'>
                                        ...
                                        <label className='text-white text-2xl'>Date</label>
                                        <input type='date' onChange={setDatef} defaultValue={date} className='border-2 border-purple-800 rounded-lg p-2 m-2' />
                                        <label className='text-white text-2xl'>Time</label>
